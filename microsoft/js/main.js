...
function 진짜할일(){
    ...
    if(window.innerWidth >= 860){
        ...
        var clonnigUl2 = document.querySelector('.attachedul')
        //console.log(clonnigUl2)
        if(clonnigUl2 === null)return;
        clonnigUl2.remove()//화면이 커졌을때 아예 없애주기
...
function addChild() {
    if ( document.querySelector('.attachedul')) return;
    var clonningUl = gnbUtilElem.cloneNode(true);
    navElem.appendChild(clonningUl);
    clonningUl.classList.add('attachedul');
} 
...
// liElem = document.querySelector('.attachedul')
// console.log(liElem)
// liElem.addEventListener('click', innerDrop)
// const clonnigLiElems = document.querySelector('nav > ul.attachedul')  
// console.log(clonnigLiElems)
// function innerDrop(ev){
//     console.log(ev)
//     ev.preventDefault()
//     const clonnigLiElems = document.querySelectorAll('.attachedul > li')
// }
...
document.addEventListener("DOMContentLoaded", function(ev) { 
    ...
    console.log('111')
    const clonnigLiElems = document.querySelector('nav > ul.attachedul')
    //console.log(navElem.childNodes)   
});
...
// }
console.log(navElem.childNodes)
console.log(Array.isArray(navElem.childNodes))

var  유사배열 = navElem.children
